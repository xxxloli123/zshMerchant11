...
public class ShopDao extends AbstractDao<Shop, Long> {
    ...
    public static class Properties {
        ...
        public final static Property Invoice = new Property(41, String.class, "invoice", false, "INVOICE");
    }
    ...
    protected final void bindValues(DatabaseStatement stmt, Shop entity) {
        ...
        String invoice = entity.getInvoice();
        if (invoice != null) {
            stmt.bindString(42, invoice);
        }
    }
    ...
    public Shop readEntity(Cursor cursor, int offset) {
        Shop entity = new Shop( //
            ...
            cursor.isNull(offset + 41) ? null : cursor.getString(offset + 41) // invoice
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Shop entity, int offset) {
        ...
        entity.setInvoice(cursor.isNull(offset + 41) ? null : cursor.getString(offset + 41));
     }
